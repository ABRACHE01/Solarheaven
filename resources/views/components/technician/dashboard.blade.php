                ...
                <div class="grid overflow-hidden text-white shadow-xl md:grid-cols-2 bg-blue-600 rounded-xl">
                    <aside class="p-8 space-y-4 md:p-16">
                        <h2 class="text-2xl font-bold tracking-tight md:text-4xl font-headline">
                            We are happy and proud to have you as a technician in our team.
                        </h2>
    
                        <p class="font-medium text-blue-100 md:text-2xl">
                           Here to help you to grow and to help our clients to find the best technicians for their needs.
                        </p>

                        {{-- buttons to see ower technicians and services --}}

                        <div class="flex flex-col space-y-4 md:flex-row md:space-x-4 md:space-y-0">
                            <a href="{{ route('appointments.index') }}" class="inline-flex items-center justify-center w-full px-5 py-3 text-base font-medium leading-6 text-white transition duration-150 ease-in-out bg-green-500 border border-transparent rounded-md shadow-sm hover:bg-green-600 focus:outline-none focus:shadow-outline md:w-auto">
                    ...
                    <aside class="relative hidden md:block">
                        <img class="absolute inset-0 object-cover object-left-top w-full h-full  -mr-16 rounded-tl-lg" src="{{  asset('img/techdash.jpg') }}" alt="tech">
                    </aside>
                </div>
            </div>
        </div>
            ...
            <div class="overflow-x-auto round p-3">
                <table class="table-auto w-full">
                    ...
                    <tbody class="text-sm divide-y divide-gray-100">
                        <!-- record 1 -->
                        @foreach ($technicianAppointments as $appointment)
                        <tr>
                            <td class="p-2">
        ...
        <header class="px-5 py-4 border-b border-gray-100">
            ...
            <div class="overflow-x-auto round p-3">
                <table class="table-auto w-full">
                    ...
                    <tbody class="text-sm divide-y divide-gray-100">
                        <!-- record 1 -->
                        @if (!is_null($technicianReviews))
                        @foreach ($technicianReviews as $review)
                        <tr>
                            <td class="p-2">
                                <div class="font-medium text-gray-800">
                             #{{ $review->id}}
...
<section class="grid grid-cols-1 gap-5 sm:grid-cols-1 mt-4 lg:grid-cols-3 sm:px-6 md:px-8  justify-items-center ">
