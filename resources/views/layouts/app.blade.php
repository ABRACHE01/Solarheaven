            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    @else
                        ...
                        <li class="nav-item">
                            <a class="nav-link"  href="{{ route('tech.index') }}" >technicians</a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('appointments.index') }}">appointements</a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                               ...
                               <a class="dropdown-item" href="{{route('profile.index',Auth::user()->id)}}">PROFILE SETTINGS</a>
                            </div>
                        </li>
                    @endguest
                </ul>
