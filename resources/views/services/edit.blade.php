...
@include('components.authnavbar')
 ...
 <h4
 class="md:text-8xl xl:text-1 text-center font-bold font-heading tracking-px-n pt-14 leading-none">Update a Service </h4>
  ...
  <div class="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
        <div class="mx-auto w-full max-w-[550px] ">
            ...
            <div class="mb-5">
                ...
                class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                id="description" name="description" >{{ $service->description }}</textarea>
