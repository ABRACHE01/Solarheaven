...
@include('components.authnavbar')
    ...
    <div class="bg-white dark:bg-gray-800  px-32  mt-16 ">
            <div class="container mx-autor bg-white dark:bg-gray-800 rounded">
                ...
                <div class="xl:w-full border-b border-gray-300 dark:border-gray-700 py-5">
                  ...
                  <div class="mx-auto pt-4">
                    ...
                    @endif
                        ...
                        {{-- <div class="xl:w-1/4 lg:w-1/2 md:w-1/2 flex flex-col mb-6 ">
                          <label for="State/Province" class="pb-2 text-sm font-bold text-gray-800 dark:text-gray-100">repeate password </label>
                          <input tabindex="0" type="password" id="newpassword" name="password_confermation" required class="border border-gray-300 dark:border-gray-700 pl-3 py-3 shadow-sm bg-transparent rounded text-sm focus:outline-none focus:border-indigo-700 placeholder-gray-500 text-gray-600 dark:text-gray-400" placeholder="**************" />
                      @if ($errors->has('password_confermation'))
                      <small class="form-text text-danger">{{ $errors->first('password_confermation') }}</small>
                      @endif
                        </div> --}}
